...
for epoch in range(num_epochs):
    ...
    if validation_accuracy > best_accuracy:
        torch.save(model,'C:\THIS PC\WPI\FALL 2021\CS 539 Machine Learning\Project\Results\Basic\\best_model.pth')
        best_accuracy = validation_accuracy




best_model = torch.load('C:\THIS PC\WPI\FALL 2021\CS 539 Machine Learning\Project\Results\Basic\\best_model.pth')
best_model.eval()
test_accuracy = 0.0
...
plt.legend()
plt.title('Model Training (Unrpuned)')
plt.show()